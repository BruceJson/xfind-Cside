<template>
    <div class='edit_box'>
        ...
        <Form ref='careermind_form' class='baseinfo_form' :model="formData" :rules="rules">
            <Row>
                <Col span='12'>
                <FormItem :label-width='120' label='项目名称' prop='name'>
            ...
            <Row>
                <Col span='12'>
                <FormItem :label-width='120' label='项目时间' prop='time'>
            ...
            <Row>
                <Col span='12'>
                <FormItem :label-width='120' label='所属公司' prop='company'>
            ...
            <Row>
                <Col span='24'>
                <FormItem :label-width='120' label='说明' prop='desc'>
                    <Input type='textarea' :rows='5' v-model="formData.desc" placeholder="请输入工作描述"></Input>
                </FormItem>
                </Col>
            </Row>
...
export default {
    ...
    methods: {
        userDataSubmit() {
            // 表单验证 开发时注释打开按需修改
            // this.$refs['careermind_form'].validate((valid) => {
            //  if (valid) {
