<template>
	<div class='talent_list_page job_manager_page'>
		<div class='content_inner_width'>
			<tab class='table_tabs' v-model='curIndex'>
				<tab-item class='tab_item' tab-index='0'>发布中职位</tab-item>
				<tab-item class='tab_item' tab-index='1'>已暂停职位</tab-item>
				<tab-item class='tab_item' tab-index='2'>全部职位</tab-item>
				<tab-item class='tab_item' tab-index='3'>职位模板</tab-item>
			...
			<transition name='slide-fade' mode='out-in'>
				<component :is='currentComp' :key='currentComp' :type='curIndex'></component>
			</transition>
		</div>
	</div>
</template>
