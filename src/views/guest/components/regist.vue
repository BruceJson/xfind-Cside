<template>
	<!-- 注册 -->
	<div class='content_login_box regist_login_box'>
		<div class='line line1'>
			<x-link class='a1' to='./' :show-arrow='true' color='#333333' @click.native='goLogin'>已有账号？立即登录</x-link>
		</div>
		...
		<div class='line line5'>
			<x-button class='xbtn_bradius btn_login' fontsize='14' color='#fff' width='100%'>注册</x-button>
		</div>
		<flexbox class='line line6' align-items='center'>
			<p>注册代表您已同意</p>
			<x-link class='a1' to='' :show-arrow='false' color='#00d2ff'>《讯聘用户协议》</x-link>
		</flexbox>
	</div>
</template>
